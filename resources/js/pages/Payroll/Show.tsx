            ...
            <div className="p-4 md:p-6 lg:p-8 max-w-5xl mx-auto">
                ...
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 print:hidden gap-4">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h1 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-white">Detail Penggajian</h1>
                    ...
                    <div className="flex gap-2">
                        ...
                        <a href={route('payroll.print', payroll.id)} target="_blank" rel="noopener noreferrer">
                            <Button className="bg-indigo-600 hover:bg-indigo-700 text-white shadow-sm rounded-xl h-10">
                ...
                <Card className="border-t-4 border-t-indigo-600 shadow-lg overflow-hidden bg-white dark:bg-zinc-900">
                    <div className="bg-gray-50 dark:bg-zinc-800/50 p-6 border-b border-gray-100 dark:border-zinc-800 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                        <div className="flex items-center gap-4">
                        ...
                        <div className="text-right">
                            <Badge className="bg-emerald-600 mb-1 px-3 py-1">LUNAS / PAID</Badge>
                    ...
                    <CardContent className="p-0">
                        <div className="grid grid-cols-1 md:grid-cols-2">
                            ...
                            <div className="p-6 md:p-8 bg-gray-50/50 dark:bg-black/20">
                                ...
                                {/* GRAND TOTAL */}
                                <div className="bg-white dark:bg-zinc-900 p-4 md:p-6 rounded-xl border border-indigo-100 dark:border-indigo-900 shadow-sm text-center">
                                    <p className="text-xs text-gray-500 uppercase font-semibold mb-1">Total Diterima (Take Home Pay)</p>
                                    <p className="text-2xl md:text-3xl font-extrabold text-indigo-700 dark:text-indigo-400">{formatCurrency(payroll.gaji_bersih)}</p>
                                </div>
                            </div>
