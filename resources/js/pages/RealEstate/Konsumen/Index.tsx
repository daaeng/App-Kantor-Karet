...
export default function Index({ konsumens }: { konsumens: any[] }) {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="relative overflow-hidden bg-gradient-to-r from-violet-600 to-fuchsia-900 pb-32 pt-12">
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-4 text-white mb-2">
                            ...
                            <div>
                                ...
                                <p className="text-violet-100 mt-1">Kelola *leads*, calon prospek, hingga pembeli final.</p>
                            </div>
                        </div>
