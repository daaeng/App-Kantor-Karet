...
export default function Index({ suppliers }: { suppliers: any[] }) {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="relative overflow-hidden bg-gradient-to-r from-teal-600 to-cyan-800 pb-32 pt-12">
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-4 text-white mb-2">
                            ...
                            <div>
                                ...
                                <p className="text-teal-100 mt-1">Data partner penyedia material (seperti Wijaya Mandiri) beserta total hutang</p>
                            </div>
                        </div>
