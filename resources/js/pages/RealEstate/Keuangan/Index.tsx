...
export default function KeuanganProperti({ transaksis, projects, penjualans, receipts, summary, chartData, filter, currentMonth, currentYear }: PageProps) {
    ...
    const submitTransaction = (e: React.FormEvent) => {
        ...
        const transformPayload = (data: any) => ({
            ...data,
            housing_project_id: data.housing_project_id === '' ? null : data.housing_project_id,
            penjualan_kavling_id: data.penjualan_kavling_id === '' ? null : data.penjualan_kavling_id,
            material_receipt_id: data.material_receipt_id === '' ? null : data.material_receipt_id,
        });
        ...
        if (editingTransactionId) {
            trxForm.put(route('real-estate.transaksi-keuangan.update', editingTransactionId), options);
        } else {
            trxForm.post(route('real-estate.transaksi-keuangan.store'), options);
        }
    };

    const executeDeleteTransaction = () => {
        if (!transactionToDelete) return;
        router.delete(route('real-estate.transaksi-keuangan.destroy', transactionToDelete), {
            preserveScroll: true,
            onSuccess: () => {
    ...
    const applyFilter = (period: string, month: string, year: string, sYear: string, eYear: string, sMonth?: string, eMonth?: string) => {
        ...
        router.get(route('real-estate.transaksi-keuangan.index'), params, { preserveState: true, replace: true });
    };
                        ...
                        <TabsContent value="dashboard" className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-6">
                                ...
                                <Card className="group bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-950/50 dark:to-orange-950/50 border-0 shadow-2xl hover:shadow-amber-500/20 transition-all duration-500 hover:-translate-y-2">
                                    ...
                                    <CardContent className="px-6 pb-6">
                                        <div className="text-3xl lg:text-4xl font-black tracking-tight text-amber-700 dark:text-amber-400">
                                            {formatCurrency(summary.reports.neraca.assets.kas_period)}
                                        </div>
                                    </CardContent>
                                </Card>
                                ...
                                <Card className="group bg-gradient-to-br from-rose-50 to-pink-50 dark:from-rose-950/50 dark:to-pink-950/50 border-0 shadow-2xl hover:shadow-rose-500/20 transition-all duration-500 hover:-translate-y-2">
                                    ...
                                    <CardContent className="px-6 pb-6">
                                        <div className={`text-3xl lg:text-4xl font-black tracking-tight ${summary.reports.profit_loss.net_profit >= 0 ? 'text-rose-600 dark:text-rose-400' : 'text-red-600 dark:text-red-400'}`}>
                        ...
                        <TabsContent value="profit-loss" className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
                            <Card className="max-w-4xl mx-auto border-0 shadow-2xl overflow-hidden bg-white dark:bg-slate-950">
                                ...
                                <CardContent className="pt-10 px-12 pb-12 space-y-3">
                                    ...
                                    <LedgerItem label="Total Pendapatan" value={summary.reports.profit_loss.revenue} isIndent />
                                    <LedgerTotal label="Total Pendapatan" value={summary.reports.profit_loss.revenue} />
                                    ...
                                    <LedgerItem label="Total Pengeluaran" value={summary.reports.profit_loss.opex} isIndent isMinus />
                                    <LedgerTotal label="Total Pengeluaran" value={summary.reports.profit_loss.opex} />
                                    <div className="mt-10"></div>
                                    <LedgerTotal label="LABA BERSIH" value={summary.reports.profit_loss.net_profit} isGrandTotal />
                                </CardContent>
                            </Card>
                        </TabsContent>
                                ...
                                <CardContent className="pt-10 px-12 pb-12">
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                                        <div className="bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-950/50 dark:to-indigo-950/50 p-8 rounded-3xl border-2 border-blue-100 dark:border-blue-900">
                                            ...
                                            <LedgerItem label="Kas" value={summary.reports.neraca.assets.kas_period} isIndent />
                                            <LedgerItem label="Bank" value={summary.reports.neraca.assets.bank_period} isIndent />
                                        ...
                                        <div className="bg-gradient-to-br from-rose-50 to-pink-50 dark:from-rose-950/50 dark:to-pink-950/50 p-8 rounded-3xl border-2 border-rose-100 dark:border-rose-900">
                                            ...
                                            <LedgerItem label="Hutang Dagang" value={summary.reports.neraca.liabilities.hutang_dagang} isIndent />
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                                <Card className="border-0 shadow-2xl overflow-hidden">
                                    ...
                                    <CardContent className="p-8">
                                        ...
                                        <LedgerItem label="Total Kas Masuk" value={summary.reports.kas.total_in} />
                                        ...
                                        <LedgerItem label="Total Kas Keluar" value={summary.reports.kas.total_out} isMinus />
                                ...
                                <Card className="border-0 shadow-2xl overflow-hidden">
                                    ...
                                    <CardContent className="p-8">
                                        ...
                                        <LedgerItem label="Total Bank Masuk" value={summary.reports.bank.total_in} />
                                        <LedgerTotal label="Total Bank Masuk" value={summary.reports.bank.total_in} />
                                        <h4 className="font-black border-b-3 border-rose-500 pb-3 mb-4 mt-8 text-lg text-slate-800 dark:text-white">UANG KELUAR</h4>
                                        <LedgerItem label="Total Bank Keluar" value={summary.reports.bank.total_out} isMinus />
                                ...
                                <form onSubmit={submitTransaction} className="px-8 py-8 space-y-6 bg-white dark:bg-slate-950">
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <div className="grid gap-2">
                                            ...
                                            <Select onValueChange={(v) => trxForm.setData('housing_project_id', v === '' ? null : Number(v))} value={trxForm.data.housing_project_id?.toString() || ''}>
                                                <SelectTrigger className="h-11 rounded-xl"><SelectValue placeholder="Pilih Proyek" /></SelectTrigger>
                                                <SelectContent>
                                                    <SelectItem value="">-- Tidak Dialokasikan --</SelectItem>
                                    ...
                                    {trxForm.data.type === 'income' && (
                                        <div className="grid gap-2 p-3 bg-emerald-50/50 rounded-lg border border-emerald-100">
                                            ...
                                            <Select onValueChange={(v) => trxForm.setData('penjualan_kavling_id', v === '' ? null : Number(v))} value={trxForm.data.penjualan_kavling_id?.toString() || ''}>
                                                <SelectTrigger className="h-11 rounded-xl"><SelectValue placeholder="Pilih Penjualan Kavling" /></SelectTrigger>
                                                <SelectContent>
                                                    <SelectItem value="">-- Tidak Tautkan --</SelectItem>
                                    ...
                                    {trxForm.data.type === 'expense' && (
                                        <div className="grid gap-2 p-3 bg-rose-50/50 rounded-lg border border-rose-100">
                                            ...
                                            <Select onValueChange={(v) => trxForm.setData('material_receipt_id', v === '' ? null : Number(v))} value={trxForm.data.material_receipt_id?.toString() || ''}>
